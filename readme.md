...
The idea is to do a Calculator project based on: [Calculator](https://github.com/florinpop17/app-ideas/blob/master/Projects/1-Beginner/Calculator-App.md).
I will check the different features as I'm doing this project
